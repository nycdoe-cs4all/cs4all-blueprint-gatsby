...
const IntroToComputationalMedia = () => (
 <Layout>
    ...
    <div className="col-md-12">
      <header><span className="preamble"><h2 className="title"  style="line-height:1;">Introduction to Computational Media</h2></span></header>
      ...
      <div className="article-content">
        ...
        <a href="https://nycdoe-cs4all.github.io/" target="blank">
          <div className="btn">
            <h4>View the Introduction to Computational Media curriculum</h4>
          </div>
        </a>
        </div>
...
export default IntroToComputationalMedia
