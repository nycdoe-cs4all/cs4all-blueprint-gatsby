...
export default const ICan = () => (
 <Layout>
	...
	<div className="col-md-9" id="mean">  <p>Computer science (CS) is the practice of its concepts from a student's perspective. As students learn computer science, they should be able to articulate their understanding of what they've learned. </p>
	  ...
	  <p>Teachers are encouraged to use the following tool to develop  learning objectives based on what they want students to be able to do at varying levels of CS cognitive complexity.</p></div>
	<br>
	<br>
	<div className="col-md-3">
	</div>
	  ...
	  <div style={{clear: 'both'}} id="contain">
		...
		<div id="statement">
		  ...
		  <div className="dropdown">
			<button id="perspective" className="dropbtn perspective" style={{}}>Perspective</button>
			<div className="dropdown-content ">
			  <a className="e perbtn perspectiveinvert">Explorer</a>
		  ...
		  <div className="dropdown">
			<button id="concept" className="dropbtn concept" style={{}}>Concept</button>
			<div className="dropdown-content" >
		...
		<div style={{margin: '10px 0px 10px 0px'}} id="loaderContainer">
		</div>
		<section>
