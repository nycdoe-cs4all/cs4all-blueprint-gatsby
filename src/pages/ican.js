...
const ICan = () => (
  <Layout>
    ...
    <div>
      ...
      {/* practices */}
      <div className="ancon2" hidden="hidden"><span className="infoTitle">Analyze:</span><br/>People of all backgrounds must evaluate and respond to the ways that computing is affecting their lives, their families and friends, and their communities. Government, industry, start-ups, non-profits, researchers, artists and many others use the principles of computing to accomplish a fast-growing number of things. Some of these things we may think of as beneficial or malicious, but others we’re still not sure how to evaluate.<br /><br /><a href="/practices#analyze" target="external" rel="prefetch" className="readMore green-media">Read More >></a><br /><br /></div>
      <div className="cocon2" hidden="hidden"><span className="infoTitle">Communicate:</span><br/>Postsecondary pursuits, whether it be college or career, will require students to communicate the complex thought processes behind their work with computer science. Students will work with collaborators, professors, advisors, project leaders, customers, and many others on issues or projects around computing. These people will be interested in the how and why behind students projects or thoughts.<br /><br /><a href="/practices#communicate" target="external" className="readMore greenMedia">Read More >></a><br /><br /></div>
      <div className="prcon2" hidden="hidden"><span className="infoTitle">Prototype:</span><br/>The goal of the prototyping practice is to help students build a mental model of how to use a computer to create new applications. Computer applications or programs like word processors or web browsers define how we use computers in a limited way.When we practice prototyping computing projects, we are creating our own applications, using computers in different ways than when we fire up our word processor or web browser.<br /><br /><a href="/practices#prototype" target="external" className="readMore greenMedia">Read More >></a><br /><br /></div>

      {/* concepts */}
      <div className="abcon2" hidden="hidden"><span className="infoTitle">Abstraction:</span><br/>An abstraction represents a simplified idea or problem derived by ignoring details and using patterns or general characteristics. A simple example of a CS abstraction is a programming language, they allow programmers to give complex instructions to computers without worrying about the bits and bytes!<br /><br /><a href="/concepts#abstraction" target="external" className="readMore whiteMedia">Read More >></a><br /><br /></div>
      <div className="alcon2" hidden="hidden"><span className="infoTitle">Algortihms:</span><br/>Algorithms are generalized and repeatable sequence of instructions that achieve a particular purpose and output, given a set of inputs. It is important to understand when, why, and how to implement an algorithm and to consider who or what might be affected.<br /><br /><a href="/concepts#algorithm" target="external" className="readMore whiteMedia">Read More >></a><br /><br /></div>
      <div className="pcon2" hidden="hidden"><span className="infoTitle">Programming:</span><br/>Programming is about giving instructions to computers. Programming can be done through a constantly changing set of languages and frameworks. Each language is translated from human-readable code into machine code that can be executed by the computer’s central processing unit, CPU.<br /><br /><a href="/concepts#programming" target="external" className="readMore whiteMedia">Read More >></a><br /><br /></div>
      <div className="dcon2" hidden="hidden"><span className="infoTitle">Data:</span><br/>Computers can be used to collect, store, and analyze massive amounts of data quickly and reliably. Computers programs can use data to make decisions or automate tasks. <br /><br /><a href="/concepts#data" target="external" className="readMore whiteMedia">Read More </a><br /><br /></div>
      <div className="ncon2" hidden="hidden"><span className="infoTitle">Networks:</span><br/>Networks, like the Internet, allow computers to interface with other computers through a set of rules, or protocols, that define how computers send and receive data. Protocols and standards are created and agreed upon by groups of people.<br /><br /><a href="/concepts#networks" target="external" className="readMore whiteMedia">Read More >></a><br /><br /></div>

      {/* perspectives */}
      <div className="econ2" hidden="hidden"><span className="infoTitle">Explorer:</span><br/>Students begin their CS journey as Explorers playing with computing. To make CS real to them, Explorers manipulate computing applications, problems, and topics with physical or visual manifestations.<br /><br /><a href="/perspectives#explorer" target="external" className="readMore blackMedia">Read More >></a><br /><br /></div>
      <div className="ccon2" hidden="hidden"><span className="infoTitle">Creator:</span><br/>Students continue their CS journey as Creators expressing their ideas through computing. Intrigued by the possibilities of computing, Creators use computing to represent their ideas, thoughts, or interests.<br /><br /><a href="/perspectives#creator" target="external" className="readMore blackMedia">Read More >></a><br /><br /></div>
      <div className="icon2" hidden="hidden"><span className="infoTitle">Innovate:</span><br/>Innovators engage with open-ended topics connected to the work of individuals in public, private and open-source domains of CS practice.<br /><br /><a href="/perspectives#innovator" target="external" className="readMore blackMedia">Read More >></a><br /><br /></div>
      <div className="zcon2" hidden="hidden"><span className="infoTitle">Citizen:</span><br/>Citizens examine and try to influence the intersection of computing with social, economic and political systems.<br /><br /><a href="/perspectives#citizen"target="external"  className="readMore blackMedia">Read More >></a><br /><br /></div>
    </div>
  </Layout>
)
export default ICan
