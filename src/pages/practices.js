    ...
    <SEO title="Practices" />
		<div id="page">
			<article className="green-theme">
				...
				<section id="practice-analyze" className="accordion-target">

					<header>
						<a className="box accordion" href="#practice-analyze">
					...
					<div className="section-content">
						...
						<table className="ordered">
							...
							<caption>Skills for Analyzing</caption>
							...
							<tbody>
								...
								<tr>
									<th>Describing</th>
									<td><p>Describe an application of computing by detailing who, what, where, when. In this first step, focus on things that can be observed.</p></td>
									<td dataColumn="Example"><p>A keyboard allows users to input data into a computer. It has keys with letters, symbols and other functions.</p></td>
								</tr>

								<tr>
									<th>Examining</th>
									<td><p>Examine the description for patterns, general characteristics, or anomalies. How do the parts of the whole relate to each other and the user?</p></td>
									<td dataColumn="Example"><p>The letter keys are not arranged alphabetically. Some keys affect the behavior of others. Users need know the placement of, and how to read the keys.</p></td>
								</tr>
								...
								<tr>
									<th>Evaluating</th>
									<td><p>Evaluate the application of computing, based on your investigation. What are its benefits and evils; and to whom, how much, when and how? What are potential modifications and the arguments for and against?</p></td>
									<td dataColumn="Example"><p>The keyboard works great for people that memorize the keys and know all the functions. Blind people or people without full control of their fingers may experience difficulties.</p></td>
								</tr>
							</tbody>
						</table>
				...
				<section id="practice-prototype" className="accordion-target">

					<header>
						<a className="box accordion" href="#practice-prototype">
							<div className="box-content">
					...
					<div className="section-content">
						...
						<table className="ordered">
							...
							<caption>Skills for Prototyping</caption>
							...
							<tbody>
								...
								<tr>
									<th>Iterating</th>
									<td><p>Use testing to solve a multi-step puzzle, complete a multi-step tutorial, fix a broken computing artifact, complete an incomplete computing artifact.</p></td>
									<td dataColumn="Example"><p>Using a Javascript coding tutorial I made a website that has a button that displays the date and time on the page when I click it.</p></td>
								</tr>
								...
								<tr>
									<th>Planning</td>
									<td><p>Research, imagine, plan, create and test possible computing artifacts that try to express an idea or solve a problem.</p> </br><p>The idea or problem is provided but does not have specific constraints.</p></td>
									<td dataColumn="Example"><p>I created an interactive “About Me” website that lets users get random facts about me by clicking a button. I had to research how to randomly choose from a list of facts about me. I had planned to do more, but that took a long time so next time I’ll try to plan better.</p></td>
								</tr>

								<tr>
									<th>Designing</th>
									<td><p>Identify an interesting and significant idea or problem and research, imagine, plan, create and iterate computing artifacts that try to express that idea or solve that problem.</p> </br><p>The idea or problem is not provided and does not have specific constraints.</p></td>
									<td dataColumn="Example">
										<p>I wanted to create a website that could collect the location of businesses in my neighborhood that need to throw away food at the end of the day so people or food banks could pick up that food.</p>
										</br>
										<p>I researched how to build a form on my website for users to input information, how to save that information in a database, and display the data on a page on my site. I had trouble working with databases so I couldn’t save the data after a person leaves the website. I plan on figuring out how to make that work so the website will be useful to my community.</p></td>
								</tr>
				...
				<section id="practice-communicate" className="accordion-target">
					...
					<header>
						<a className="box accordion" href="#practice-communicate">
							<div className="box-content">
					...
					<div className="section-content">
						...
						<p>Students should practice the skills required to communicate their higher-order CS thinking, go through the <a href="#analyze">analyze</a> and <a href="#prototype">prototype</a> practices, and not just complete those activities.</p>


						<table className="ordered">

							<caption>Skills for Communicating</caption>
				...
				<div className="exit-menu">
					<ol className="list-unstyled">
						<li>
							...
							<a className="box" href="/outcomes/" role="button"><span className="box-content">Outcomes</span></a>
						</li>
					</ol>
				</div>
