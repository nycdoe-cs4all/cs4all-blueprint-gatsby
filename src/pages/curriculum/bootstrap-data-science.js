    ...
    <div id="page">
      <article className="light-theme">
        <div className="col-md-12">
          ...
          <header>
            <span className="preamble"><h2 className="title"  style={{lineHeight: 1}}>Bootstrap: Data Science</h2></span>
          </header>

          <div className="article-content" style={{textAlign: 'center'}}>
            <iframe title="Bootstrap: Data Science intro video" src="https://www.youtube.com/embed/0DvKWmJrEGg" width="640" height="360" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div className="article-content">
            ...
            <p><a href="https://www.youtube.com/watch?v=0DvKWmJrEGg" target="blank">Watch this video</a> and <a href="https://docs.google.com/document/d/1NzVVaR5ufXbrXBl2hlmQtGUlj1U1a-jikC-W74cuR9g/edit?usp=sharing" target="blank">view this fact sheet</a> for more information.</p>
            <div className="submenu">
              <a href="https://www.bootstrapworld.org/materials/fall2019/courses/data-science/en-us/" target="blank">
                <div className="btn"><h4>Bootstrap: Data Science curriculum</h4></div>
              </a>
            </div>
            <div className="submenu">
              <a href="https://docs.google.com/document/d/1NzVVaR5ufXbrXBl2hlmQtGUlj1U1a-jikC-W74cuR9g/edit?usp=sharing" target="blank">
                <div className="btn"><h4>Bootstrap: Data Science fact sheet</h4></div>
              </a>
            </div>
          </div>
