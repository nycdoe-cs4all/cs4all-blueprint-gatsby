    ...
    <div id="page">
      <article className="light-theme">
        <div className="col-md-12">
          ...
          <header>
            <span className="preamble"><h2 className="title"  style={{lineHeight: 1}}>Introduction to Physical Computing</h2></span>
          </header>

          <div className="article-content" style={{textAlign: 'center'}}>
            <iframe title="Introduction to Physical Computing intro video" src="https://player.vimeo.com/video/250914986" width="640" height="360" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
          </div>
          ...
          <div className="article-content">
            ...
            <p><a href="https://vimeo.com/250914986" target="blank">Watch this video</a> and <a href="https://docs.google.com/document/d/1yVLZ-SDuu-hgxc4MaJqOFwXe2M6tmPfbNk20iixoVgY/edit?usp=sharing" target="blank">view this fact sheet</a> for more information.</p>
            <p>Note: Due to COVID-19 CS4All is exploring PD delivery models and foresees the uncertainty of access to materials. Given all the changing matters, after careful consideration, we must sadly inform you that the CS4All team has decided to cancel the Intro to Physical Computing course in SY 2020-21.</p>
            <div className="submenu">
              <a href="https://drive.google.com/open?id=1-9_AeFCkec2YeEcMhJujIb_jiBazWKgs" target="blank">
                <div className="btn"><h4>Introduction to Physical Computing curriculum</h4></div>
              </a>
            </div>
            <div className="submenu">
              <a href="https://docs.google.com/document/d/1yVLZ-SDuu-hgxc4MaJqOFwXe2M6tmPfbNk20iixoVgY/edit?usp=sharing" target="blank">
                <div className="btn"><h4>Introduction to Physical Computing fact sheet</h4></div>
              </a>
            </div>
          </div>
