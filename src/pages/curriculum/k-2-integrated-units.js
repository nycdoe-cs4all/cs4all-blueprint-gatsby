        ...
        <div className="col-md-12">
          ...
          <div className="article-content">
            ...
            <div className="submenu">
              <a
                href="https://drive.google.com/drive/folders/11wVbjlVsbOGR5IUuo2flVMUE1WZJKxSh?usp=sharing"
                target="blank"
              >
                <div className="btn">
                  <h4>
          ...
          <div className="article-content">
            <p>
              Computer Science and Me introduces students to the idea of
              computers and computing by posing questions such as “What is a
              computer?” and “How do computers work?" Students learn about the
              different parts of a computer and their functions (hardware,
              software). Students explore how computers work by identifying
              important aspects of computing such as algorithms, programming and
              abstraction in order to apply their new skills to a culminating
              final project. Teachers can choose to utilize an online project
              through the Scratch Jr. platform or an unplugged project that can
              be integrated into a content area.
            </p>
            <div className="submenu">
              <a
                href="https://drive.google.com/drive/folders/1in-6rYjude0AOOjoTIDICIT8gxIA8-Ae?usp=sharing"
                target="blank"
              >
                <div className="btn">
                  <h4>
                    K-2 Integrated Unit (2019-20): Computer Science and Me
                    curriculum
                  </h4>
                </div>
              </a>
          ...
          <div className="article-content">
            ...
            <div className="submenu">
              <a
                href="https://drive.google.com/drive/folders/11u95FrS3OZZqa1SDmbQDltOOg_PEvt8G?usp=sharing"
                target="blank"
              >
                <div className="btn">
                  <h4>
                    K-2 Integrated Unit (2018-19): Computing Through Time
                    curriculum
                  </h4>
                </div>
              </a>
