    ...
    <div id="page">
      <article className="light-theme">
        <div className="col-md-12">
          ...
          <header>
            <span className="preamble"><h2 className="title"  style={{lineHeight: 1}}>3-5 Integrated Units</h2></span>
          </header>

          <div className="article-content" style={{textAlign: 'center'}}>
            <iframe title="3-5 Integrated Units intro video" src="https://www.youtube.com/embed/Zky38KE11H4?rel=0" width="640" height="360" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
          </div>
          ...
          <div className="article-content">
            ...
            <div className="submenu">
              <a href="https://drive.google.com/drive/folders/1JufIAUnmyYWq8eDojjBogTWnVqsR7_FH?usp=sharing" target="blank">
                <div className="btn"><h4>3-5 Integrated Unit (2020-21): Introduction to Programming curriculum</h4></div>
              </a>
            </div>
          </div>
          ...
          <div className="article-content">
            ...
            <div className="submenu">
              <a href="https://drive.google.com/open?id=1pawMvbbM7RxtzL7QvcQYgAkXP4dSZ9tx" target="blank">
                <div className="btn"><h4>3-5 Integrated Unit (2019-20): Creating From Scratch curriculum</h4></div>
              </a>
            </div>
          </div>
