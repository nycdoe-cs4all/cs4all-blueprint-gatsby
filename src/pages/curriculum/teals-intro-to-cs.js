    ...
    <div id="page">
      <article className="light-theme">
        <div className="col-md-12">
          ...
          <header>
            <span className="preamble"><h2 className="title"  style={{lineHeight: 1}}>TEALS Introduction to Computer Science</h2></span>
          </header>
          ...
          <div className="article-content">
            ...
            <p><a href="https://docs.google.com/document/d/1Qs9AZfcKwfOPiYT9Ysn_t2MbI67EZzxLhlZnap-yxpw/edit?usp=sharing" target="blank">View this fact sheet</a> for more information.</p>
            <div className="submenu">
              <a href="https://tealsk12.gitbook.io/intro-cs" target="blank">
                <div className="btn"><h4>TEALS Introduction to Computer Science curriculum</h4></div>
              </a>
            </div>
            <div className="submenu">
              <a href="https://docs.google.com/document/d/1Qs9AZfcKwfOPiYT9Ysn_t2MbI67EZzxLhlZnap-yxpw/edit?usp=sharing" target="blank">
                <div className="btn"><h4>TEALS Introduction to Computer Science fact sheet</h4></div>
              </a>
            </div>
          </div>
