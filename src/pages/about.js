...
export default const About = () => (
	<Layout>
		...
		<article className="light-theme">
				...
				<header>
					<h2><span className="preamble">About the</span> Blueprint</h2>
				...
				<div id="about-blueprint" className="article-content">
					...
					<p>
						<a className="btn btn-sm open" href="#about-blueprint-more">
							<span className="label inactive">Read More</span>
							<span className="label active">Collapse Text</span>
						</a>
					</p>
					...
					<div className="section-content">
						...
						<ul>
							...
							<li>
								...
								<h4>Tech and tech-related industry at CS4ALL industry roundtables</h4>
								Collaboration and critical thinking are equally important to technical skills.
							</li><li>
								<h4>School leaders at principal and assistant principal conferences</h4>
				...
				<section id="about-fellows">
					...
					<div className="section-content">
						...
						<div id="fellows" className="chart">
				            ...
				            </div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/ariadna-phillips-santos.png`)"}}>
				            ...
				            </div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/ben-samuels-kalow.png`)"}}>
				            ...
				            </div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/christa-quint.jpg`)"}}>
				            	<div className="fellow-content">
				            ...
				            </div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/christy-crawford.png`)"}}>
				            	<div className="fellow-content">
							...
							</div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/joann-westhall.png`)"}}>
								<div className="fellow-content">
									<h4>JoAnn Westhall</h4>
									<img src="http://blueprint.cs4all.nyc/static/images/assets/joann-westhall.png" width="250px" height="250px" />
									<span className="fellow-text">JoAnn Westhall is a Computer Science Instructor, Grades Pre-K-5 at PS 31 in Bayside, Queens.
									</span>
								</div>

							</div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/matt-boyle.png`)"}}>
								<div className="fellow-content">
									<h4>Matt Boyle</h4>
							...
							</div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/sean-pawelec.jpg`)"}}>
								<div className="fellow-content">
									<h4>Sean Pawelec</h4>
							...
							</div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/tim-feimer.png`)"}}>
								<div className="fellow-content">
				            	    <h4>Tim Feimer</h4>
			            	...
			            	</div><div className="fellow" style={{backgroundImage: "url(`http://blueprint.cs4all.nyc/static/images/assets/tim-chen.png`)"}}>
			            		<div className="fellow-content">
				            	    <h4>Tim Chen</h4>
						...
						<div className="article-content introduction">
							...
							<div id="about-fellows-more" className="read-more">
								...
								by folks who love teaching computer science and learned to teach it, just like you, while in the classroom.</p>

								<p>A final thought before we jump into the nitty-gritty. Why CS4All? After all, not everyone will become a computer programmer, and that is totally fine. Not every student will become a novelist, but every student has the right to read great literature,
								to be exposed to the possibility that she can create something great and enduring. CS4All is about unlocking potential.  Our objective is not to produce coders, but young people who think about code and are not afraid to try to read and write it. </p>
								<p>In
						...
						<div className="case-study">
							...
							<p> The Blueprint Fellowship for the 2017-18 school year is structured as two tracks - Curriculum and Pedagogy. We have almost 50 teachers participating this year!</p>

							<p>The Curriculum Fellows, who got started in early July 2017, are designed Blueprint-aligned CS units to test in the classroom and eventually publish on the Blueprint. The Pedagogy Fellows will meeting in August to kick-off a year of interivistation and peer observation that will published as video <a href="/resources">resources</a> on the Blueprint.</p>
