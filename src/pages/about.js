        ...
        <section id="fellows">
          ...
          <div className="section-content">
            <div id="fellows" className="chart">
              <div className="fellow" style={{backgroundImage: 'url(' + alana + ')'}}>
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + ariadna + ')'}}>
                <div className="fellow-content">
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + ben + ')'}}>
                <div className="fellow-content">
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + christa + ')'}}>
                <div className="fellow-content">
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + christy + ')'}}>
                <div className="fellow-content">
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + joann + ')'}}>
                <div className="fellow-content">
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + matt + ')'}}>
                <div className="fellow-content">
                  <h4>Matt Boyle</h4>
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + sean + ')'}}>
                <div className="fellow-content">
                  <h4>Sean Pawelec</h4>
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + timF + ')'}}>
                <div className="fellow-content">
                  <h4>Tim Feimer</h4>
              ...
              <div className="fellow" style={{backgroundImage: 'url(' + timC + ')'}}>
                <div className="fellow-content">
                  <h4>Tim Chen</h4>
            ...
            <div id="about-fellows" className="article-content introduction">
              ...
              <div id="about-fellows-more" className="read-more" ref={fellowContent} style={{ maxHeight: `${fellowHeight}` }}>
                ...
                <p>In the history of computer science, we have mostly been content to wait for prodigies to drive innovation. We believe there is more prodigious talent in our students that can be unlocked by learning to create and iterate. These resources are a commitment
