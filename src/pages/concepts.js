		...
		<div id="page">
			<article className="orange-theme">
				...
				<header>
					...
					<p className="subhead">A framework for what computers can and cannot do.</p>
				</header>
				...
				<section id="concept-abstraction" className="accordion-target">

					<header>
						<a className="box accordion" href="#concept-abstraction">
						...
						<table >
							...
							<tbody>
								...
								<tr >
									...
									<td dataColumn="ELA" className="placeholder"></td>
								</tr>
							</tbody>
						</table>
				...
				<section id="concept-algorithms" className="accordion-target" >

					<header>
						<a className="box accordion" href="#concept-algorithms">
							<div className="box-content">
						...
						<table >
							...
							<tbody>
								...
								<tr >
									...
									<td><p >How <span className="c28"><a className="c49" href="http://blueprint.cs4all.nyc/concepts#data">data</a>&nbsp;is passed into (inputs,) manipulated by, used within (variables,) and returned from the algorithm (outputs).</p><p >&nbsp;</p></td>
									<td dataColumn="Math">
				...
				<section id="concept-programming" className="accordion-target">

					<header>
						<a className="box accordion" href="#concept-programming">
							<div className="box-content">
				...
				<section id="concept-data" className="accordion-target">

					<header>
						<a className="box accordion" href="#concept-data">
							<div className="box-content">
				...
				<section id="concept-networks" className="accordion-target">

					<header>
						<a className="box accordion" href="#concept-networks">
							<div className="box-content">
						...
						<table >
							...
							<tbody>
								...
								<tr>
									...
									<td dataColumn="Math" className="placeholder"></td>
