...
export default const UTeachCSPrinciples = () => (
 <Layout>
    <SEO title="UTeach CS Principles" />
    <div id="page">
      <article className="light-theme">
		<div className="col-md-12">
		  <header><span className="preamble"><h2 className="title"  style={{line-height: 1}}>UTeach AP Computer Science Principles</h2></span></header>
