          ...
          <ul className="activity-list">
            ...
            <li>
              <a href="/curriculum/k-2-integrated-units">
                <div className="preview"><img src={k2Units} alt="K-2 Integrated Units" /></div>
                <h3>
            ...
            <li>
              <a href="/curriculum/3-5-integrated-units">
                <div className="preview"><img src={three5Units} alt="3-5 Integrated Units" /></div>
                <h3>
          ...
          <ul className="activity-list">
            ...
            <li>
              <a href="/curriculum/6-8-integrated-units">
                <div className="preview"><img src={six8Units} alt="6-8 Integrated Units" /></div>
                <h3>
