        ...
        <ul className="activity-list">
          ...
          <li>
            <a href="/curriculum/units-k2-computer-science-and-me">
              <div className="preview"><img src="/static/images/assets/k2-units.jpg" alt="grades K-2 innovator unit" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/units-35-creating-from-scratch">
              <div className="preview"><img src="/static/images/assets/35-units.jpg" alt="grades 3-5 innovator unit" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/units-68-innovative-programming">
              <div className="preview"><img src="/static/images/assets/68-units.jpg" alt="grades 6-8 innovator unit" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/computational-media-explorer">
              <div className="preview"><img src="/static/images/assets/elementary_2.jpg" alt="computational media explorer unit" /></div>
              <h3>
                <span className="activity-grade">Grades K-2</span>
          ...
          <li>
            <a href="/curriculum/computational-media-creator">
              <div className="preview"><img src="/static/images/assets/pic1.jpg" alt="computational media creator unit" /></div>
              <h3>
                <span className="activity-grade">Grades 3-5</span>
          ...
          <li>
            <a href="/curriculum/software-engineering-program-jr">
              <div className="preview"><img src="/static/images/assets/pic14.jpg" alt="Software Engineering Program Jr" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/computational-media-innovator">
              <div className="preview"><img src="/static/images/assets/high_2a.jpg" alt="Computational Media Innovator" /></div>
              <h3>
                <span className="activity-grade">Grades 6-8</span>
          ...
          <li>
            <a href="/curriculum/creative-computing/">
              <div className="preview"><img src="/static/images/assets/creative-computing.gif" alt="Creative Computing" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/critical-computing/">
              <div className="preview"><img src="http://cs4all.nyc/wp-content/uploads/2020/02/critical-computing.png" alt="Critical Computing" /></div>
              <h3>
                <span className="activity-grade">Grade 6</span>
          ...
          <li>
            <a href="/curriculum/creative-web/">
              <div className="preview"><img src="/static/images/assets/creative-web.gif" alt="Creative Web" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/intro-to-pcomp/">
              <div className="preview"><img src="/static/images/assets/intro-to-pcomp.gif" alt="Introduction to Physical Computing" /></div>
              <h3>
                <span className="activity-grade">Grade 7</span>
          ...
          <li>
            <a href="/curriculum/cs-discoveries">
              <div className="preview"><img src="https://i.ytimg.com/vi/uQim0hBHco0/mqdefault.jpg" alt="Code.org CS Discoveries" /></div>
              <h3>
                <span className="activity-grade">Grades 6-8</span>
          ...
          <li>
            <a href="/curriculum/software-engineering-program/">
              <div className="preview"><img src="http://cs4all.nyc/wp-content/uploads/2016/09/SEP-Hackathon.jpg" alt="Software Engineering Program" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/bootstrap-data-science">
              <div className="preview"><img src="http://cs4all.nyc/wp-content/uploads/2020/02/bootstrap-data-science.png" alt="Bootstrap Data Science" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/exploring-cs">
              <div className="preview"><img src="https://pbs.twimg.com/profile_images/3176850259/72da25556ca103ca5ad6bf21af7be1ea_400x400.jpeg" alt="Exploring Computer Science" /></div>
              <h3>
                <span className="activity-grade">Grades 9-10</span>
          ...
          <li>
            <a href="/curriculum/teals-intro-to-cs">
              <div className="preview"><img src="/static/images/assets/TEALS.gif" alt="TEALS Introduction to Computer Science" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/intro-to-computational-media">
              <div className="preview"><img src="/static/images/assets/intro-to-comp-media.gif" alt="Introduction to Computational Media" /></div>
              <h3>
                <span className="activity-grade">Grade 9-10</span>
          ...
          <li>
            <a href="/curriculum/tangible-interfaces">
              <div className="preview"><img src="/static/images/assets/tangible-interfaces.gif" alt="Introduction to Computational Media" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/cs-principles">
              <div className="preview"><img src="/static/images/assets/cs-principles.jpg" alt="Computer Science Principles" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/cs-a">
              <div className="preview"><img src="/static/images/assets/cs-a.gif" alt="CS A" /></div>
              <h3>
          ...
          <li>
            <a href="/curriculum/cs-and-the-city">
              <div className="preview"><img src="/static/images/assets/cs-and-the-city.gif" alt="CS and the City" /></div>
              <h3>
                <span className="activity-grade">Grades 11-12</span>
