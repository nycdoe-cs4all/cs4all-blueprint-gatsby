		...
		<div id="page">
			<article className="blue-theme">
				...
				<div className="article-content">
					<p className="intro">Meaningful computer science units help students fully embrace a perspective such that they are ready and interested in progressing to the next.</p>
				</div>

				<section id="perspective-explorer" className="accordion-target">

					<header>
						<a className="box accordion" href="#perspective-explorer">
					...
					<div className="section-content">
						...
						<div className="introduction col-sm-6 col-md-7">

							<p className="headline">&ldquo;I can play with computing practices and concepts.&rdquo;</p>
						...
						<div className="case-study col-sm-6 col-md-5">

								<a target="_blank" href="http://alpha.editor.p5js.org/KCintheNYC/sketches/Hyvg4Kw8Z">
									<img src="/static/images/assets/explorer-robot.jpg" alt="" />
								</a>
			     ...
			     <section id="perspective-creator" className="accordion-target">

			     	<header>
			     		<a className="box accordion" href="#perspective-creator">
			     			<div className="box-content">
			     	...
			     	<div className="section-content">
						...
						<div className="introduction col-sm-7">

							<p className="headline">&ldquo;I can express myself with computing practices and concepts&rdquo;</p>
						...
						<div className="case-study col-sm-5">

							<a target="_blank" href="http://ariellehein.com/projects.html">
								<img src="/static/images/assets/perspective-arielle.jpg" alt="" />
							</a>
			     ...
			     <section id="perspective-innovator" className="accordion-target" >

			     	<header>
		     			<a className="box accordion" href="#perspective-innovator">
		     				<div className="box-content">
		     		...
		     		<div className="section-content">
						...
						<div className="introduction col-sm-7">
							...
							<p className="headline">&ldquo;I can connect to the work of others using computing practices and concepts.&rdquo;</p>
						...
						<div className="case-study col-sm-5">
							...
							<a target="_blank" href="https://tonejs.github.io/">
								<img src="/static/images/assets/perspective-innovator.jpg" alt="" />
							</a>
				...
				<section id="perspective-citizen" className="accordion-target">

					<header>
						<a className="box accordion" href="#perspective-citizen">
							<div className="box-content">
					...
					<div className="section-content">
						...
						<div className="introduction col-sm-7">
							...
							<p className="headline">&ldquo;I can question how computing practices and concepts affect my community.&rdquo;</p>
						...
						<div className="case-study col-sm-5">
							...
							<a target="_blank" href="https://www.mhpbooks.com/books/networks-of-new-york/">
								<img src="/static/images/assets/perspective-citizen.jpg" alt="" />
							</a>
