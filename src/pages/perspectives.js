      ...
      <article className="blue-theme">
        ...
        <section id="perspective-explorer" className="accordion-target">
          <header>
            ...
            <div className="case-study col-sm-6 col-md-5">
              <a target="_blank" href="http://alpha.editor.p5js.org/KCintheNYC/sketches/Hyvg4Kw8Z"><img src="/static/images/assets/explorer-robot.jpg" alt="" /></a>
        ...
        <section id="perspective-creator" className="accordion-target">
          ...
          <div className="section-content">
            ...
            <div className="case-study col-sm-5">
              <a target="_blank" href="http://ariellehein.com/projects.html"><img src="/static/images/assets/perspective-arielle.jpg" alt="" /></a>
        ...
        <section id="perspective-innovator" className="accordion-target" >
          ...
          <div className="section-content">
            ...
            <div className="case-study col-sm-5">
              <a target="_blank" href="https://tonejs.github.io/"><img src="/static/images/assets/perspective-innovator.jpg" alt="" /></a>
        ...
        <section id="perspective-citizen" className="accordion-target">
          ...
          <div className="section-content">
            ...
            <div className="case-study col-sm-5">
              <a target="_blank" href="https://www.mhpbooks.com/books/networks-of-new-york/"><img src="/static/images/assets/perspective-citizen.jpg" alt="" /></a>
      ...
      <div className="interior-container">
        <div className="exit-menu">
          <ol className="list-unstyled">
            ...
            <li className="current"><a href="">Perspectives</a></li>
            <li>
              <div className="box">
