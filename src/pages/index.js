						...
						<div className="row gallery">
							...
							<div className="col-sm-6 col-md-4">
								<a className="box" href="/units/#">
									...
									<h3>
										Art Machine
										<span className="subtitle">k-2 | ELA &amp; Art</span>
									</h3>
								</a>
							</div>
							...
							<div className="col-sm-12 col-md-4">
								<a className="box" href="/units/#">
									...
									<h3>
										...
										<span className="subtitle">6-8 | ELA</span>
									</h3>
								</a>
							</div>
							...
							<div className="col-sm-6 col-md-4">
								<a className="box" href="/units/#">
									...
									<h3>
										Exploring Biorobotics
										<span className="subtitle">9-12 | Science</span>
									</h3>
								</a>
							</div>
				...
				<div className="exit-links">
					...
					<div className="box" style={{display: 'none'}} className="hero">
						<a className="btn" href="/units/" role="button">
							<span className="preamble">Explore more</span>
							Units
						</a>
