  ...
  <Layout>
    ...
    <div>
      ...
      <div className="ancon2" hidden="hidden">
        ...
        <a href="/practices#analyze" target="external" rel="prefetch" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="cocon2" hidden="hidden">
        ...
        <a href="/practices#communicate" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="prcon2" hidden="hidden">
        ...
        <a href="/practices#prototype" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      ...
      <div className="abcon2" hidden="hidden">
        ...
        <a href="/concepts#abstraction" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="alcon2" hidden="hidden">
        ...
        <a href="/concepts#algorithm" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="pcon2" hidden="hidden">
        ...
        <a href="/concepts#programming" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="dcon2" hidden="hidden">
        ...
        <a href="/concepts#data" target="external" className="readMore">Read More </a><br /><br />
      </div>
      <div className="ncon2" hidden="hidden">
        ...
        <a href="/concepts#networks" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      ...
      <div className="econ2" hidden="hidden">
        ...
        <a href="/perspectives#explorer" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="ccon2" hidden="hidden">
        ...
        <a href="/perspectives#creator" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="icon2" hidden="hidden">
        ...
        <a href="/perspectives#innovator" target="external" className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
      <div className="zcon2" hidden="hidden">
        ...
        <a href="/perspectives#citizen"target="external"  className="readMore">Read More &gt;&gt;</a><br /><br />
      </div>
    </div>
  </Layout>
)
