  ...
  plugins: [
    {
      ...
      options: {
         ...
         */
        baseUrl: `cs4allblueprint.wordpress.com`,
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        ...
        theme_color: `#663399`,
        display: `minimal-ui`,
        icon: `src/assets/svg/icon-blueprint.svg`, // This path is relative to the root of the site.
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
    ...
    },
    {
      ...
      options: {
        ...
        trackingIds: [
          "UA-84670539-2", // Google Analytics / GA
